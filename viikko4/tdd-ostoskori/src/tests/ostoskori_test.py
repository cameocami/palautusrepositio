...
class TestOstoskori(unittest.TestCase):
    ...
    def test_yhden_tuotteen_poistamisen_jalkeen_kun_tuotetta_on_ollut_kaksi_korissa_ostokset_palauttaa_oikean_lukumaaran(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(maito)
    ...
    def test_yhden_tuotteen_poistamisen_jalkeen_kun_tuotetta_on_ollut_yksi_korissa_ostokset_on_tyhja(self):
        maito = Tuote("Maito", 3)
        self.kori.lisaa_tuote(maito)
        self.kori.poista_tuote(maito)
        ostokset = self.kori.ostokset()
    ...
    def test_tyhjentamisen_jalkeen_kori_on_tyhja(self):
        maito = Tuote("Maito", 3)
        juusto = Tuote("Juusto", 5)
        self.kori.lisaa_tuote(maito)
        self.kori.lisaa_tuote(juusto)
